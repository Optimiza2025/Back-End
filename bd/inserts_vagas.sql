...
(10, 'Analista de Dados Pleno', 'Analista', '3+ anos', 'Ensino_superior_completo', 'USP',
...
(11, 'Assistente Financeiro', 'Assistente', '1+ anos', 'Ensino_medio_completo', 'Senac',
 'Administração',
 '{"Português": "C2"}',
 '["Contas a Receber", "Contas a Pagar", "ERP", "Excel"]',
 '2025-01-05', '2025-01-22', '2025-01-22', 'Admissao_concluida', 'concluida', 1),

(12, 'Analista de RH Generalista', 'Analista', '2+ anos', 'Ensino_superior_completo', 'PUC',
...
(13, 'Desenvolvedor Backend Pleno', 'Desenvolvedor', '3+ anos', 'Ensino_superior_completo', 'UNESP',
...
(14, 'Coordenador de Marketing Digital', 'Coordenador', '4+ anos', 'Ensino_superior_completo', 'ESPM',
...
(15, 'Assistente de Operações', 'Assistente', '1 ano', 'Ensino_medio_completo', 'ETEC',
 'Logística',
 '{"Português": "C2"}',
 '["Rotinas Operacionais", "Controle de Estoque", "ERP"]',
 '2025-01-12', '2025-01-30', '2025-01-30', 'Admissao_concluida', 'concluida', 5),

(16, 'Product Owner Jr', 'Analista', '1-2 anos', 'Ensino_superior_completo', 'FGV',
...
(17, 'Analista de Compliance', 'Analista', '2+ anos', 'Ensino_superior_completo', 'USP',
...
(18, 'Analista de Suporte Técnico', 'Analista', '2+ anos', 'Ensino_superior_completo', 'FATEC',
...
(19, 'Assistente Administrativo', 'Assistente', '1 ano', 'Ensino_medio_completo', 'ETEC',
 'Administração',
 '{"Português": "C2"}',
 '["Organização de Documentos", "Atendimento", "ERP"]',
 '2025-02-06', '2025-02-20', '2025-02-20', 'Admissao_concluida', 'concluida', 2),

(20, 'Coordenador Financeiro', 'Coordenador', '4+ anos', 'Ensino_superior_completo', 'FGV',
...
(22, 'Analista de Logística', 'Analista', '2+ anos', 'Ensino_superior_completo', 'UFABC',
...
(23, 'Consultor de Segurança da Informação', 'Consultor', '3+ anos', 'Ensino_superior_completo', 'USP',
...
(24, 'Analista de Treinamento e Desenvolvimento', 'Analista', '2+ anos', 'Ensino_superior_completo', 'PUC',
...
(25, 'Analista de Controladoria', 'Analista', '3+ anos', 'Ensino_superior_completo', 'FGV',
 'Administração, Economia ou Contabilidade',
 '{"Inglês": "B1", "Português": "C2"}',
...
(27, 'Desenvolvedor Frontend Pleno', 'Desenvolvedor', '3+ anos', 'Ensino_superior_completo', 'UNIP',
 'Sistemas de Informação',
 '{"Inglês": "B1", "Português": "C2"}',
 '["JavaScript", "React", "APIs", "HTML/CSS"]',
 '2025-03-04', '2025-03-23', '2025-03-23', 'Admissao_concluida', 'concluida', 3),

(28, 'Analista de Mídias Sociais', 'Analista', '2+ anos', 'Ensino_superior_completo', 'ESPM',
...
(29, 'Analista de Planejamento Operacional', 'Analista', '2+ anos', 'Ensino_superior_completo', 'UFABC',
 'Logística ou Administração',
 '{"Português": "C2"}',
 '["Gestão de Demandas", "KPIs", "Processos", "ERP"]',
 '2025-03-08', '2025-03-27', '2025-03-27', 'Admissao_concluida', 'concluida', 5),

(30, 'Analista de Segurança da Informação SOC', 'Analista', '2+ anos', 'Ensino_superior_completo', 'USP',
...
(31, 'Designer de UX/UI', 'Designer', '2+ anos', 'Ensino_superior_completo', 'Belas Artes',
 'Design Digital',
 '{"Português": "C2"}',
 '["Figma", "UX Research", "Wireframes", "Design System"]',
 '2025-03-11', '2025-03-28', '2025-03-28', 'Admissao_concluida', 'concluida', 4),

(32, 'Assistente de Departamento Pessoal', 'Assistente', '1 ano', 'Ensino_medio_completo', 'Senac',
 'Administração',
 '{"Português": "C2"}',
 '["Folha de Pagamento", "Admissão", "Rescisão", "Ponto"]',
 '2025-03-12', '2025-03-30', '2025-03-30', 'Admissao_concluida', 'concluida', 2),

(33, 'Analista de Custos', 'Analista', '2+ anos', 'Ensino_superior_completo', 'Mackenzie',
...
(34, 'Coordenador de Operações', 'Coordenador', '4+ anos', 'Ensino_superior_completo', 'FGV',
...
(35, 'Assistente de Compras', 'Assistente', '1 ano', 'Ensino_medio_completo', 'ETEC',
 'Administração',
 '{"Português": "C2"}',
...
(37, 'Engenheiro de Software Pleno', 'Engenheiro', '3+ anos', 'Ensino_superior_completo', 'USP',
...
(39, 'Analista de Auditoria Interna', 'Analista', '2+ anos', 'Ensino_superior_completo', 'FGV',
...
(40, 'Analista de Infraestrutura', 'Analista', '3+ anos', 'Ensino_superior_completo', 'FATEC',
...
(41, 'Coordenador de RH', 'Coordenador', '4+ anos', 'Ensino_superior_completo', 'PUC',
 'Recursos Humanos',
 '{"Português": "C2"}',
 '["Liderança", "KPIs de RH", "Desenvolvimento Organizacional"]',
 '2025-04-09', '2025-04-28', '2025-04-28', 'Admissao_concluida', 'concluida', 2),

(42, 'Analista de Operações Logísticas', 'Analista', '2+ anos', 'Ensino_superior_completo', 'Mackenzie',
...
-- FINANCEIRO
(43, 'Analista Financeiro Pleno', 'Analista', '3+ anos', 'Ensino_superior_completo', 'FGV',
...
-- RH
(44, 'Business Partner Jr', 'Analista', '2+ anos', 'Ensino_superior_completo', 'PUC',
...
-- TI
(45, 'Desenvolvedor Backend Node.js', 'Desenvolvedor', '2+ anos', 'Ensino_superior_completo', 'FATEC',
...
-- OPERAÇÕES
(47, 'Coordenador de Operações', 'Coordenador', '4+ anos', 'Ensino_superior_completo', 'Mackenzie',
...
(49, 'Analista de Treinamento e Desenvolvimento', 'Analista', '1+ ano', 'Ensino_superior_completo', 'PUC',
...
-- FINANCEIRO
(50, 'Coordenador Financeiro', 'Coordenador', '4+ anos', 'Ensino_superior_completo', 'FEA-USP',
...
-- RH
(51, 'Analista de Recrutamento e Seleção Sr', 'Analista', '3+ anos', 'Ensino_superior_completo', 'PUC',
 'Psicologia ou Recursos Humanos',
 '{"Português": "C2"}',
...
-- TI
(52, 'Desenvolvedor Full Stack Pleno', 'Desenvolvedor', '3+ anos', 'Ensino_superior_completo', 'FATEC',
 'Sistemas de Informação ou correlatos',
 '{"Inglês": "B1", "Português": "C2"}',
...
-- MARKETING
(53, 'Especialista em Performance Digital', 'Especialista', '4+ anos', 'Ensino_superior_completo', 'ESPM',
...
-- OPERAÇÕES
(54, 'Supervisor de Logística', 'Supervisor', '3+ anos', 'Ensino_superior_completo', 'Mackenzie',
 'Logística ou Administração',
 '{"Português": "C2"}',
...
-- FINANCEIRO 2
(56, 'Analista Contábil Jr', 'Analista', '1+ ano', 'Ensino_superior_completo', 'FGV',
 'Contabilidade',
 '{"Português": "C2"}',
...
-- FINANCEIRO
(57, 'Analista de Controladoria Pleno', 'Analista', '3+ anos', 'Ensino_superior_completo', 'FGV',
...
-- TI
(59, 'Desenvolvedor Backend Node.js', 'Desenvolvedor', '2+ anos', 'Ensino_superior_completo', 'FATEC',
 'Sistemas de Informação',
 '{"Inglês": "B1", "Português": "C2"}',
...
-- MARKETING
(60, 'Analista de Social Media Sr', 'Analista', '3+ anos', 'Ensino_superior_completo', 'ESPM',
 'Publicidade e Propaganda',
 '{"Português": "C2"}',
...
-- FINANCEIRO
(64, 'Analista Financeiro Jr', 'Analista', '1+ ano', 'Ensino_superior_completo', 'Mackenzie',
 'Administração ou Contabilidade',
 '{"Português": "C2"}',
...
-- RH
(65, 'Analista de Treinamento & Desenvolvimento Pleno', 'Analista', '2+ anos', 'Ensino_superior_completo', 'PUC',
 'Recursos Humanos',
 '{"Português": "C2"}',
...
-- TI
(66, 'Desenvolvedor Front-End React', 'Desenvolvedor', '2+ anos', 'Ensino_superior_completo', 'FATEC',
 'Sistemas de Informação',
 '{"Inglês": "B1", "Português": "C2"}',
...
-- MARKETING
(67, 'Analista de SEO', 'Analista', '2+ anos', 'Ensino_superior_completo', 'ESPM',
 'Marketing ou Publicidade',
 '{"Português": "C2"}',
...
-- OPERAÇÕES
(68, 'Analista de Planejamento Logístico', 'Analista', '2+ anos', 'Ensino_superior_completo', 'Mackenzie',
...
-- FINANCEIRO 2
(70, 'Assistente Financeiro', 'Assistente', '1 ano', 'Ensino_medio_completo', 'ETEC',
 'Administração',
 '{"Português": "C2"}',
...
-- FINANCEIRO
(71, 'Analista de Custos Pleno', 'Analista', '2+ anos', 'Ensino_superior_completo', 'FGV',
 'Contabilidade ou Administração',
 '{"Português": "C2"}',
...
-- RH
(72, 'Analista de Benefícios Sr', 'Analista', '3+ anos', 'Ensino_superior_completo', 'PUC',
 'Recursos Humanos',
 '{"Português": "C2"}',
...
-- TI
(73, 'Engenheiro de Software Backend', 'Engenheiro', '3+ anos', 'Ensino_superior_completo', 'USP',
 'Ciência da Computação ou correlatos',
 '{"Inglês": "B1", "Português": "C2"}',
...
-- OPERAÇÕES
(75, 'Analista de Supply Chain', 'Analista', '2+ anos', 'Ensino_superior_completo', 'Mackenzie',
 'Logística ou Engenharia de Produção',
 '{"Português": "C2"}',
...
-- TI 2
(76, 'Analista DevOps Jr', 'Analista', '1+ ano', 'Ensino_superior_completo', 'FIAP',
 'Sistemas de Informação',
 '{"Inglês": "A2", "Português": "C2"}',
...
-- FINANCEIRO 2
(77, 'Assistente Fiscal', 'Assistente', '1+ ano', 'Ensino_medio_completo', 'ETEC',
 'Administração',
 '{"Português": "C2"}',
...
-- FINANCEIRO
(78, 'Analista Financeiro Pleno', 'Analista', '2+ anos', 'Ensino_superior_completo', 'USP',
...
-- TI
(80, 'Desenvolvedor Fullstack Jr', 'Desenvolvedor', '1+ ano', 'Ensino_superior_completo', 'FIAP',
 'Sistemas de Informação',
 '{"Inglês": "B1", "Português": "C2"}',
...
-- OPERAÇÕES
(82, 'Coordenador de Operações', 'Coordenador', '3+ anos', 'Ensino_superior_completo', 'Mackenzie',
